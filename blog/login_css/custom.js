...
/* NUMBER ANIMATION */
(function(a){a.fn.animateNumber=function(b,c,d){var e=a(this),f=d?parseInt(e.val()):parseInt(e.php());var g=b>f,h=1;var i=function(){f=Math.floor(g?f+h:f-h);if(g&&f>b||!g&&f<b){f=b;clearInterval(j)}e.php(f);if(d){e.val(f);d()}};var j=setInterval(i,c)}})(jQuery);
/*
 Fusionfile v0.1
    ...
    a.fn.jqTransSelect = function () {
        return this.each(function (b) {
            ...
            a("option", this).each(function (b) {
                var c = a('<li><a href="#" index="' + b + '">' + a(this).php() + "</a></li>");
                h.append(c)
            });
